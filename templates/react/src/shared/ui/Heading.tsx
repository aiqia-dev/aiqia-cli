...
const headingVariants = cva('font-semibold items-center gap-2', {
  variants: {
    variant: {
      ...
      h3: 'scroll-m-20 mb-5 text-lg tracking-tight',
      h4: 'scroll-m-20 text-xs uppercase text-foreground/60',
    },
  },
  defaultVariants: {
    variant: 'h1',
